"""
Original Code
https://github.com/ermongroup/Wifi_Activity_Recognition/blob/master/cross_vali_input_data.py
...
def csv_import():
    ...
    return x_dic["bed"], x_dic["fall"], x_dic["pickup"], x_dic["run"], x_dic["sitdown"], x_dic["standup"], x_dic[
        "walk"], \
